...
import { firovm as btcNetwork, Network } from './networks';
...
const DEFAULT_OPTS: PsbtOpts = {
  /**
   * A firovmjs Network object. This is only used if you pass an `address`
 ...
 *   Combine checks if the internal firovm transaction is the same, so be sure that
 ...
 * It contains a firovmjs-lib Transaction object.
 */
