...
import * as varuint from 'varuint-firovm';
export { varuint };
...
/**
 * Helper class for serialization of firovm data types into a pre-allocated buffer.
 */
...
/**
 * Helper class for reading of firovm data types from a buffer.
 */
