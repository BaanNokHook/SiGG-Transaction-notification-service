...
export class Transaction {
   ...
   *
   * firovm uses a different hash for each signed transaction input.
  ...
  hashForSignature(
    ...
    // https://github.com/firovm/firovm/blob/master/src/test/sighash_tests.cpp#L29
    ...
    if ((hashType & 0x1f) === Transaction.SIGHASH_NONE) {
      ...
      // https://github.com/firovm/firovm/blob/master/src/test/sighash_tests.cpp#L60
  ...
  hashForWitnessV1(
    ...
    // https://github.com/firovm/bips/blob/master/bip-0341.mediawiki#common-signature-message
    typeforce(
      types.tuple(
        types.UInt32,
    ...
    // https://github.com/firovm/bips/blob/master/bip-0341.mediawiki#cite_note-14
    // With extension from:
    // https://github.com/firovm/bips/blob/master/bip-0342.mediawiki#signature-validation
    const sigMsgSize =
      174 -
      (isAnyoneCanPay ? 49 : 0) -
      (isNone ? 32 : 0) +
    ...
    // https://github.com/firovm/bips/blob/master/bip-0341.mediawiki#cite_note-19
